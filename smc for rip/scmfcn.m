...
f1=(b2*c1-b1*c2)/(a1*b2-b1*a2);
g1=b2/(a1*b2-b1*a2);
f2=(-a2*c1+a1*c2)/(a1*b2-b1*a2);
g2=-a2/(a1*b2-b1*a2);
...
% c=4*m*L*L/3;
% d=m*9.81*L;
% g=(kt*km+beq*rm)/rm;% f1=(-(b^2/2)*sin(2*alpha)*dalpha^2 - g*b*dtheta*cos(alpha) + a*d*sin(alpha))/(a*c-b^2*(cos(alpha))^2);
